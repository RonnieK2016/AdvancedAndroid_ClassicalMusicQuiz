...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener, ExoPlayer.EventListener {
    ...
    // COMPLETED: Create a method that shows a MediaStyle notification with two actions (play/pause, skip to previous). Clicking on the notification should launch this activity. It should take one argument that defines the state of MediaSession.
    ...
    public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
        ...
        // COMPLETED: Call the method to show the notification, passing in the PlayBackStateCompat object.

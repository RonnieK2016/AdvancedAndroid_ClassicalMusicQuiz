...
// COMPLETED: Have this Activity implement ExoPlayer.EventListener and add the required methods.
public class QuizActivity extends AppCompatActivity implements View.OnClickListener, ExoPlayer.EventListener {
    ...
    private void initializePlayer(Uri mediaUri) {
        if (mExoPlayer == null) {
            ...
            // COMPLETED: Set the ExoPlayer.EventListener to this activity
    ...
    // COMPLETED: Add conditional logging statements to the onPlayerStateChanged() method that log when ExoPlayer is playing or paused.
